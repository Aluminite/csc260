// This is a (mostly) unchanged version of the SingleLinkedList class that I made for Lab 5.
// The code that I wrote already satisfies all the requirements needed for Lab 6, so I'm reusing it here.
